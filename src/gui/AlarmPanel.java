...
public class AlarmPanel extends JPanel{
	...
	private void initElements() {
		...
		Sheep sheep1 = new Sheep(16, "Knut", 1994, 10000, this.programFrame.getUserPanel().getFarmer(), 100, 62.10745, 9.76686, new Integer(0));
		Sheep sheep2 = new Sheep(15, "Link", 1992, 1023421, this.programFrame.getUserPanel().getFarmer(), 100, 61.99745, 9.46686, new Integer(0));
